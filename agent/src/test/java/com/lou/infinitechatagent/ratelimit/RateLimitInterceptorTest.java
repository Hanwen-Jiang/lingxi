...
class RateLimitInterceptorTest {
    ...
    void underCapacityAllowed_thenBlockedWith429AndContractCode() throws Exception {
        RateLimitInterceptor interceptor = new RateLimitInterceptor(true, 3, 60);
    ...
    void distinctSubjectsHaveIndependentBuckets() throws Exception {
        RateLimitInterceptor interceptor = new RateLimitInterceptor(true, 1, 60);
    ...
    void disabledAlwaysAllows() throws Exception {
        RateLimitInterceptor interceptor = new RateLimitInterceptor(false, 1, 60);
